    ...
    return(
        <section className="w-full  bg-lightGray px-[30px] md:px-0">
            <div className="container mx-auto">
                <div className="w-full md:w-[76%] xl:w-[60%]  md:h-[180px] md:mt-[-100px] lg:h-[140px] lg:mt-[-75px] mx-auto  mt-[-95px]   relative z-10 py-10 rounded-md  bg-[white] lg:shadow-md ">
                    <Serach />
                </div>
    ...
    return(
        <section className="w-full min-h-[400px] px-[30px] py-[40px]">
            <div className="container mx-auto flex flex-wrap">
                <section className="w-full md:w-[50%] lg:w-[40%] overflow-hidden pt-[30px] h-[400px] lg:sticky top-[50px]">
